...
import type { TutorialEntry } from "../../packs/BP/scripts/tutorial_book_entries.d.ts";

const ENTRY_PREFIX = "fluffyalien_energistics.ui.tutorialBook.entry.";

const texts = fs.readFileSync("RP/texts/en_US.lang", "utf8");
...
fs.writeFileSync(
  "BP/scripts/tutorial_book_entries.js",
